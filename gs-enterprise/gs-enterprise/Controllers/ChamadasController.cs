...
namespace gs_enterprise.Controllers
{
    public class ChamadasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DoutorId,PacienteId")] Chamada chamada)
        {
            ...
            ViewData["PacienteId"] = new SelectList(_context.Pacientes, "Id", "cpf", chamada.PacienteId);
            return View(chamada);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DoutorId,PacienteId")] Chamada chamada)
        {
            if (id != chamada.Id)
            {
                return NotFound();
        ...
        {
          return (_context.chamadas?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
